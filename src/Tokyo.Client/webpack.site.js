...
const extractCSS = new ExtractTextPlugin('tokyoclient.css');
var merge = require('extendify')({ isDeep: true, arrays: 'concat' });
var devConfig = require('./webpack.config.dev');
var prodConfig = require('./webpack.config.prod');
var isDevelopment = process.env.TOKYOTRACKER_ENVIRONMENT === 'Development';
...
module.exports = merge({
    ...
    entry: {
        tokyoclient: ['jquery', 'jquery-validation', 'jquery-validation-unobtrusive', 'tether', 'popper.js', 'bootstrap', 'bootstrap/dist/css/bootstrap.css', './sass/main.scss', './site.tsx']
    },
    output: {
        path: path.join(__dirname, '..', 'Nusushi', 'wwwroot', 'assets'),
        filename: '[name].js',
        publicPath: '/assets/',
        library: 'Tokyotracker'
    },
    plugins: [
        extractCSS,
